...
<div class="page-content">
    <div class="main-wrapper">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><img src="/tema/admin/circladmin-10/circl/theme/assets/images/avatars/profile-image.png" alt="">Anna Doe</th>
                                        <td>Modern</td>
                                        <td>#53327</td>
                                        <td>$20</td>
                                    ...
                                    <tr>
                                        <th scope="row"><img src="/tema/admin/circladmin-10/circl/theme/assets/images/avatars/profile-image.png" alt="">John Doe</th>
                                        <td>Alpha</td>
                                        <td>#13328</td>
                                        <td>$25</td>
                                    ...
                                    <tr>
                                        <th scope="row"><img src="/tema/admin/circladmin-10/circl/theme/assets/images/avatars/profile-image.png" alt="">Nina Doe</th>
                                        <td>Space</td>
                                        <td>#54773</td>
                                        <td>$20</td>
                                        <td><span class="badge bg-success">Paid</span></td>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-4">
                <div class="card">
                    <img src="/tema/admin/circladmin-10/circl/theme/assets/images/card-bg.png" class="card-img-top" alt="...">
                    <div class="card-body">
