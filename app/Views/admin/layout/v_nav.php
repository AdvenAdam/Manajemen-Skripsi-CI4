    ...
    <nav class="navbar navbar-expand-lg d-flex justify-content-between">
        ...
        <div class="" id="headerNav">
            <ul class="navbar-nav">
                            ...
                            <div class="header-notif">
                                <div class="notif-image">
                                    <span class="notification-badge">
                                        <img src="/tema/admin/circladmin-10/circl/theme/assets/images/avatars/profile-image.png" alt="">
                                    </span>
                                </div>
                                <div class="notif-text">
                                    <p>faucibus dolor in commodo lectus mattis</p>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link profile-dropdown" href="#" id="profileDropDown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="/tema/admin/circladmin-10/circl/theme/assets/images/avatars/profile-image.png" alt=""></a>
